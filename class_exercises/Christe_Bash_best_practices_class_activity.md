...
>
>#Output
>drwx------+  12 nchriste  ACCOUNTS\Domain Users   384 Sep  2 15:27 Desktop
>drwx------+  15 nchriste  ACCOUNTS\Domain Users   480 Sep  9 17:32 Documents
>drwx------+ 301 nchriste  ACCOUNTS\Domain Users  9632 Sep  9 18:01 Downloads
>>drwx------@  85 nchriste  ACCOUNTS\Domain Users  2720 Jun 25 15:10 Library
>drwx------    4 nchriste  ACCOUNTS\Domain Users   128 Dec 23  2025 Movies
>drwx------+   4 nchriste  ACCOUNTS\Domain Users   128 Dec 23  2025 Music
>drwx------+   4 nchriste  ACCOUNTS\Domain Users   128 Dec 22  2025 Pictures
>drwxr-xr-x+   4 nchriste  ACCOUNTS\Domain Users   128 Dec 22  2025 Public
>
>```
>
...
><br>
><br> I do not see a differece in using the '-p' flag and not. In Documents mkdir btec_640/class_exercises and mkdir -p btec_640/class_exercises both created a new foulder under the btec_640 folder. mk
><br>
...
> ```
>
>bash-3.2$ mkdir -p  btec_640/class_exercises/input_data
>bash-3.2$ mkdir -p  btec_640/class_exercises/final_ouput
>bash-3.2$ mkdir -p  btec_640/class_exercises/analysis
>bash-3.2$ mkdir -p  btec_640/class_exercises/src
>bash-3.2$ mkdir -p  btec_640/genomics_project/input_data
>bash-3.2$ mkdir -p  btec_640/genomics_project/final_output
>bash-3.2$ mkdir -p  btec_640/genomics_project/analysis
>bash-3.2$ mkdir -p  btec_640/genomics_project/src
>bash-3.2$ mkdir -p  btec_640/transcriptomics_projects/input_data
>bash-3.2$ mkdir -p  btec_640/transcriptomics_projects/final_output
>bash-3.2$ mkdir -p  btec_640/transcriptomics_projects/analysis
>bash-3.2$ mkdir -p  btec_640/transcriptomics_projects/src
>
>
>
>
